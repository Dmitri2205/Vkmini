...
export default class App extends React.Component {
 ...
 state = {
    ...
    componentDidMount(){
     ...
     axios.get('https://oauth.vk.com/authorize?client_id=7545593&display=popup&redirect_uri=https://dmitri2205.github.io/Vkmini/&scope=friends&response_type=token&v=5.120')
        .then((response) => { 
